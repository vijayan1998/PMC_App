              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    24.vspace,
                    const OnBoardText(text: 'Type the topic on which you want to Generate course', 
                    color: Colors.white),
                    16.vspace,
                    TextFormWidget(
                    ...
                    24.vspace,
                    const OnBoardText(text: 'Select the number of Subtopics you want this course to be spread across.', 
                    color: Colors.white),
                    16.vspace,
                    CheckBoxWidget(
                      text: '05', 
